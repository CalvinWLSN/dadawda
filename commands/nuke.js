...
module.exports.run = async(bot, message, args) =>{
  ...
  if (!message.guild.me.hasPermission('MANAGE_CHANNELS')) return message.reply(`I don't have permission \`MANAGE_CHANNELS\`!`)
  message.channel.clone().then(async channel => {
    let msg = await channel.send(`👍 Successfully Nuked this Channels!\nhttps://tenor.com/view/explosion-mushroom-cloud-atomic-bomb-bomb-boom-gif-4464831`)
